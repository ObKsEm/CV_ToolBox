...
def main():
    ...
    source_pic_root_path = '/home/lichengzhi/mmdetection/data/VOCdevkit/shell/2020.06.15'
    target_pic_root_path = '/home/lichengzhi/mmdetection/data/coco/shell/2020.06.15'
